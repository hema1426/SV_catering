package com.winapp.svcatering.multiselectspinner
...
class MultiSelectSpinnerView(context: Context, attrs: AttributeSet?) :
    ...
    private var headerSelectAll_text: MultipleSelectSpinnerPojo = MultipleSelectSpinnerPojo("All Select", false)
    private var footerConfirm_text: MultipleSelectSpinnerPojo = MultipleSelectSpinnerPojo("OK", false)
...
//                ?: "OK"
    ...
    fun buildCheckedSpinner(
        dataList: ArrayList<MultipleSelectSpinnerPojo>,
